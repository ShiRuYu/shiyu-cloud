package com.shiyu.cloud.product.log;
...
public enum LoggerUtil {
    DIGEST_LOGGER(LoggerFactory.getLogger(LogConstants.DIGEST_LOGGER)),
    DETAIL_LOGGER(LoggerFactory.getLogger(LogConstants.DETAIL_LOGGER));
